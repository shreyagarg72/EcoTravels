...
//     inactivityTimer.current = setInterval(checkInactivity, 60000); // Check every minute

//     // Auth state listener
//     const unsubscribe = onAuthStateChanged(auth, (user) => {
//       if (user) {
//         // User is signed in, start tracking inactivity
//         resetActivityTimer();
//       }
//     });
...
//   return (
//     // ... (previous render code remains unchanged)
//   );
// };

// export default LoginSignupModel;
// THE ABOVE CODE IS FOR INACTIVITY TIMEOUT RN NOT PLACING IT BUT IN FUTURE CAN HELP
