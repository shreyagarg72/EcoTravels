...
const EcoImpactCalculator = ({ trip }) => {
  ...
  const emissionFactors = {
    // Standard emissions vs eco-friendly savings (kg CO2 per unit)
    hotel: {
      standard: 25.5,
      eco: 8.5,
      saving: 17 // difference
    },
    activities: {
      standard: 5.0,
      eco: 2.5,
  ...
  useEffect(() => {
    ...
    const calculateImpact = () => {
      ...
      setImpact({
        ...
        ecoChoices: ecoChoices.slice(0, 3) // Show top 3 eco-friendly choices
      });
    };
  ...
  return (
    <div className="w-full mb-6 bg-white rounded-lg shadow-lg p-6">
      <div className="mb-6">
