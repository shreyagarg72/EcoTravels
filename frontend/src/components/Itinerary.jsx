...
// // ... (previous imports and L.Icon setup remain the same)
// import iconRetinaUrl from "leaflet/dist/images/marker-icon-2x.png";
// import iconUrl from "leaflet/dist/images/marker-icon.png";
// import shadowUrl from "leaflet/dist/images/marker-shadow.png";
...
//   // ... (distributeActivities function remains the same)
//   const distributeActivities = (activities, duration) => {
//     console.log("Raw activities:", activities);
...
//     // Get the new JSON format from localStorage
//     const storedData = JSON.parse(localStorage.getItem("selectedCitiesData")) || { selectedCities: [] };
//     const cities = storedData.selectedCities || [];
//     console.log("Stored Cities:", cities);
...
//         // Default duration to 3 if not specified in the new format
//         const duration = city.duration || 3;
