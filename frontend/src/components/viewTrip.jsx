    ...
    return (
      <div className="space-y-2">
        ...
        {activityData.ticketPrice && (
          <div className="text-gray-600">Ticket: {activityData.ticketPrice}</div>
        )}
        ...
        {activityData.rating && (
          <div className="flex items-center gap-1">
            Rating: <span className="text-yellow-500">⭐</span> {activityData.rating}
          </div>
        )}
        ...
        {activityData.travelTime && (
          <div className="text-gray-500">Travel Time: {activityData.travelTime}</div>
        )}
      </div>
    );
  };
  ...
  const renderMeal = (mealData) => {
    ...
    return (
      <div className="space-y-2">
        ...
        {mealData.priceRange && (
          <div className="text-gray-600">Price Range: {mealData.priceRange}</div>
        )}
      </div>
    );
  };
          ...
          return (
            <div key={index} className="border rounded-lg p-6 mb-6">
              ...
              <div className="mb-8">
                ...
                {day.afternoon?.activity && renderActivity(day.afternoon.activity)}
                {day.afternoon?.lunch && (
